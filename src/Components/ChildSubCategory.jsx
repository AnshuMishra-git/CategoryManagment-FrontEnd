...
function ChildSubCategory() {
        ...
        msgs3.current.show({
            severity: 'info', sticky: true, content: (
                <React.Fragment>
                    ...
                    <div className="ml-2">Child Sub Category Managment</div>
                </React.Fragment>
            )
        });
    }, []);
    ...
    const getData = async () => {
        setLoading(true)
        const updatedUrl = url.CHILD_SUB_CATEGORY;
    ...
    return (
        <div>
            ...
            {data &&
                ...
                name={'ChildSubCategory'} shortName={'Child Sub Cateogry'} deleteUrl={url.CHILD_SUB_CATEGORY_DELETE} />
            }
        </div>
    )
}
